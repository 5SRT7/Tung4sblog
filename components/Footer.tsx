...
export default function Footer() {
  return (
    <footer>
      <div className="mt-16 flex flex-col items-center bg-white/50 dark:bg-gray-950/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20 dark:border-gray-700/20">
